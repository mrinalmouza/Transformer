...
class PositionalEncoding(nn.Module):
    ...
    def __init__(self,d_model,seq_len,dropout) -> None:
        ...
        #Create of matrix of shape (seq_len,d_model)
...
class LayerNormalization(nn.Module):
    ...
    def __init__(self,features,eps=1e-6):
        super().__init__()
        self.eps = eps
        self.alpha = nn.Parameter(torch.ones(features)) # nn.parameter is used to create a parameter that will be used in the model and is learnable.
